...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '199775f6a38a806b9758da414f6dd5bb',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Maggie', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '知识收集爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-mauve-beta-18.vercel.app/', // 网站地址
